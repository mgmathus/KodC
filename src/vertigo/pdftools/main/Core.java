...
import codisee.Advance1;
import codisee.Working;
...
public class Core {
    ...
    public void setFrame1(Working frame1) {
        this.frameWorking = frame1;
    }
    
    
    public int buildpdf(List images, String filename, Advance1 ad) {
